...
const { GetById, Create, Update, Delete } = require('../../controllers/Modules/MyAccount/MyAccountController');
...
router.post( 
    ...
    [
        ...
        check("first_name", "Invalid value").not().isEmpty().isString().isLength({max: 50}),
        check("last_name", "Invalid value").not().isEmpty().isString().isLength({max: 50}),
...
router.put( 
    ...
    [
        ...
        check("id_role", "Invalid value").not().isEmpty().isInt(),
        check("id_avatar", "Invalid value").not().isEmpty().isInt(),
        check("first_name", "Invalid value").not().isEmpty().isString().isLength({max: 20}),
        check("last_name", "Invalid value").not().isEmpty().isString().isLength({max: 20}),
